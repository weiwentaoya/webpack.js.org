...
当使用 [HTML5 History API](https://developer.mozilla.org/en-US/docs/Web/API/History)时, 任意的 `404` 响应都可能需要被替代为 `index.html`. 通过设置 `devServer.historyApiFallback` 为 `true`启用:
